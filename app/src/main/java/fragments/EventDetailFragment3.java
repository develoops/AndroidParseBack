...
import mc.neuro2019.BroadcastAlarma;
 ...
 */
public class EventDetailFragment3 extends Fragment {
    ...
    public static EventDetailFragment3 newInstance(Actividad event, Actividad meetingApp, List<PersonaRolAct> rols, List<Actividad> anidados) {

        // Instantiate a new fragment

        EventDetailFragment3 fragment = new EventDetailFragment3();
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    queryContenido.findInBackground(new FindCallback<ActContAct>() {
                        ...
                        public void done(List<ActContAct> objects, ParseException e) {
                            ...
                            Fragment fragment = EventDetailFragment3.newInstance(evento, mApp,roles2,eventosAnidados2);
